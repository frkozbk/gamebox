...
const CategoryCard = () => {
	return (
		<div className='w-full h-72 rounded-lg group relative'>
			<div className='w-56 absolute left-1/2 left  transform -translate-x-1/2 h-48 mx-auto bg-orange-200 z-20 rounded-lg overflow-hidden group-hover:scale-105 duration-300'>
